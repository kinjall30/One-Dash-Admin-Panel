...
class OneDashSaleIntegration extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems : [
                { title : "One Dash", link : "#" },
                { title : "OneDash Sales", link : "#" },
    ...
    componentDidMount(){
        this.props.setBreadcrumbItems("OneDash Sales Integration", this.state.breadcrumbItems);
    }
    tog_standard() {
                        ...
                        >
                            ...
                            <ModalBody>
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col sm="10">
                                            <Input className="form-control" type="text" defaultValue="https://abc-shop.myshopify.com"  id="example-search-input"/>
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row>
                                        <Label for="example-tel-input" className="col-sm-2 col-form-label">Api Key</Label>
                                        <Col sm="10">
                                            <Input className="form-control" type="text" defaultValue="7bcc5a61440d274979e7da825088a850" id="example-search-input"/>
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row>
                                        <Label for="example-tel-input" className="col-sm-2 col-form-label">Api Password</Label>
                                        <Col sm="10">
                                            <Input className="form-control" type="text" defaultValue="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" id="example-search-input"/>
                                        </Col>
                                    </FormGroup>
                                    <FormGroup row>
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col sm="10">
                                            <Input className="form-control" type="text" defaultValue="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" id="example-search-input"/>
                                        </Col>
                                    </FormGroup>                    
                            </ModalBody>
                            <ModalFooter>
...
export default connect(null, { setBreadcrumbItems })(OneDashSaleIntegration);
