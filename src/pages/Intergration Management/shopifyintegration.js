...
class ShofiyIntegration extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems : [
    ...
    componentDidMount(){
        this.props.setBreadcrumbItems("Shopify Integration", this.state.breadcrumbItems);
    }
    tog_standard() {
                    ...
                    <Row>
                        ...
                        >
                            ...
                            <ModalBody>
                                    ...
                                    <FormGroup row>
                                        <Label for="example-url-input" className="col-sm-2 col-form-label">Storefront access Token</Label>
                                        <Col sm="10">
                                            <Input className="form-control" type="text" defaultValue="26a26117e1ddec892d29bd6e696fd6ac" id="example-url-input"/>
                                        </Col>
                                    </FormGroup> 
                                    <FormGroup row>
...
export default connect(null, { setBreadcrumbItems })(ShofiyIntegration);
