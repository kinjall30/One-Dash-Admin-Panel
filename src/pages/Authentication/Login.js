                                    ...
                                    <CardBody className="pt-0">
                                        ...
                                        <div className="p-3">
                                            ...
                                            <AvForm className="form-horizontal mt-4" onValidSubmit={this.handleSubmit}>
                                                ...
                                                <AvField name="email" placeholder="Enter Email" value={ this.state.email } onChange ={this.changeHandler}  type="email" />

                                                <label htmlFor="userpassword">Password</label>
                                                <AvField name="password" type="password" value={ this.state.password } onChange ={this.changeHandler} placeholder="Enter password" />

                                                <div className="form-group row mt-4">
                                                    <Col xs="12" className="text-right">
                                                        <Button color="primary" className="w-md waves-effect waves-light" onSubmit={this.handleSubmit}  type="submit" style ={{marginRight: 60, width: 250}}>Log In</Button>
                                                    </Col>
                                                </div>
