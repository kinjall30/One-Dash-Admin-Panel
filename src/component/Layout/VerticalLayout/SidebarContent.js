...
class SidebarContent extends Component {
    ...
    render() {
        ...
        if (this.state.roleLogin == "support") {
            ...
            sidebarMenu = <ul className="metismenu list-unstyled" id="side-menu">
                <li>
                    ...
                    <ul className="sub-menu" aria-expanded="false">
                        <li>
                            <Link to="existingcampaign">Campaign</Link>
                        </li>
                        <li>
                            <Link to="marketing">New Campaign</Link>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        {/* 
                ...
                <ul className="sub-menu" aria-expanded="false">
                    <li><Link to="existingcampaign">Campaign</Link></li>
                    <li><Link to="marketing">New Campaign</Link></li>
                </ul>
            </li>
        ...
        <li>
            ...
            <ul className="sub-menu" aria-expanded="true">
                ...
                <li><Link to="/#" className="has-arrow">Level 1.2</Link>
                    <ul className="sub-menu" aria-expanded="true">
                        <li><Link to="/#">Level 2.111</Link></li>
